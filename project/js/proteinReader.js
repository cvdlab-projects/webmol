    ...
    ProteinReader.prototype.cysteine = function(){
      ...
      protein.addBond(new Bond(1, 0, 1));
      protein.addBond(new Bond(1, 2, 1));
      protein.addBond(new Bond(1, 7, 1));
      protein.addBond(new Bond(1, 8, 1));
      protein.addBond(new Bond(2, 1, 1));
      protein.addBond(new Bond(2, 3, 1));
      protein.addBond(new Bond(2, 5, 1));
      protein.addBond(new Bond(3, 2, 1));
      protein.addBond(new Bond(4, 0, 1));
      protein.addBond(new Bond(5, 2, 1));
      protein.addBond(new Bond(5, 13, 1));
      protein.addBond(new Bond(6, 0, 1));
      protein.addBond(new Bond(7, 1, 1));
      protein.addBond(new Bond(8, 1, 1));
      protein.addBond(new Bond(8, 9, 1));
      protein.addBond(new Bond(8, 12, 1));
      protein.addBond(new Bond(8, 11, 1));
      protein.addBond(new Bond(9, 8, 1));
      protein.addBond(new Bond(9, 10, 1));
      protein.addBond(new Bond(10, 9, 1));
      protein.addBond(new Bond(11, 8, 1));
      protein.addBond(new Bond(12, 8, 1));
      protein.addBond(new Bond(13, 5, 1));
    ...
    ProteinReader.prototype.arginine = function(){
      ...
      protein.addBond(new Bond(8, 11, 1));
      protein.addBond(new Bond(9, 8, 1));
      protein.addBond(new Bond(10, 8, 1));
      protein.addBond(new Bond(11, 8, 1));
      protein.addBond(new Bond(11, 12, 1));
      protein.addBond(new Bond(11, 13, 1));
      protein.addBond(new Bond(11, 14, 1));
      protein.addBond(new Bond(12, 11, 1));
      protein.addBond(new Bond(13, 11, 1));
      protein.addBond(new Bond(14, 11, 1));
      protein.addBond(new Bond(14, 15, 1));
      protein.addBond(new Bond(14, 16, 1));
      protein.addBond(new Bond(14, 17, 1));
      protein.addBond(new Bond(15, 14, 1));
      protein.addBond(new Bond(16, 14, 1));
      protein.addBond(new Bond(16, 18, 1));
      protein.addBond(new Bond(16, 19, 1));
      protein.addBond(new Bond(17, 14, 1));
      protein.addBond(new Bond(18, 16, 1));
      protein.addBond(new Bond(18, 20, 1));
      protein.addBond(new Bond(18, 21, 1));
      protein.addBond(new Bond(19, 16, 1));
      protein.addBond(new Bond(20, 18, 1));
      protein.addBond(new Bond(20, 22, 1));
      protein.addBond(new Bond(21, 18, 1));
      protein.addBond(new Bond(21, 23, 1));
      protein.addBond(new Bond(21, 24, 1));
      protein.addBond(new Bond(22, 20, 1));
      protein.addBond(new Bond(23, 21, 1));
      protein.addBond(new Bond(24, 21, 1));
      protein.addBond(new Bond(25, 5, 1));
    ...
    ProteinReader.prototype.tryptophan = function(){
      ...
      protein.addBond(new Bond(2, 5, 1));
      protein.addBond(new Bond(3, 2, 2));
      protein.addBond(new Bond(4, 0, 1));
      protein.addBond(new Bond(5, 2, 1));
      ...
      protein.addBond(new Bond(10, 8, 1));
      protein.addBond(new Bond(11, 8, 1));
      protein.addBond(new Bond(12, 9, 2));
      protein.addBond(new Bond(12, 14, 1));
      protein.addBond(new Bond(12, 15, 1));
      protein.addBond(new Bond(13, 9, 1));
      protein.addBond(new Bond(13, 16, 2));
      protein.addBond(new Bond(13, 18, 1));
      protein.addBond(new Bond(14, 12, 1));
      protein.addBond(new Bond(15, 12, 1));
      protein.addBond(new Bond(15, 16, 1));
      protein.addBond(new Bond(15, 17, 1));
      protein.addBond(new Bond(16, 15, 1));
      protein.addBond(new Bond(16, 13, 2));
      protein.addBond(new Bond(16, 19, 1));
      protein.addBond(new Bond(17, 15, 1));
      protein.addBond(new Bond(18, 13, 1));
      ...
      protein.addBond(new Bond(20, 19, 1));
      protein.addBond(new Bond(21, 19, 2));
      protein.addBond(new Bond(21, 22, 1));
      protein.addBond(new Bond(21, 23, 1));
      protein.addBond(new Bond(22, 21, 1));
      protein.addBond(new Bond(23, 21, 1));
      protein.addBond(new Bond(23, 18, 2));
      protein.addBond(new Bond(23, 25, 1));
      protein.addBond(new Bond(24, 18, 1));
      protein.addBond(new Bond(25, 23, 1));
      protein.addBond(new Bond(26, 5, 1));
    ...
    ProteinReader.prototype.alanine = function() {
      ...
      protein.addBond(new Bond(10, 8, 1));
      protein.addBond(new Bond(11, 8, 1));
      protein.addBond(new Bond(12, 5, 1));
      return protein;
    }
